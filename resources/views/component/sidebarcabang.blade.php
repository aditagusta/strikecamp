<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a href="{{route('profilecabang')}}"><i class="fa fa-home"></i> Profile</a>
            </li>
            <li><a href="{{route('order_paket')}}"><i class="fa fa-home"></i> Entry Order Paket</a>
            </li>
            <li><a href="{{route('booking')}}"><i class="fa fa-home"></i> Entry Booking</a>
            </li>
        </ul>
    </div>
